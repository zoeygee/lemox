    ...
    <>
      ...
      <section className="py-10 py-md-12">
        <div className="container">
          <div className="row">
            <div claass="col-10 col-sm-12 col-md-10 mx-auto">
              <h1 className="display-3 mb-5">About us</h1>
              <p className="lead">
                Lemox is made up of a team of blockchain and real estate enthusiasts with a combined experience of about
                30years in these fields. Our platform transforms the world of real estate by bridging the gap between
                traditional markets and the decentralized economy.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-lg">
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8 text-center">
              ...
              <h2 className="display-4 text-white mb-9 mb-md-10">
                Why <span className="text-underline text-underline-primary-light">investors</span> choose us.
              </h2>
            </div>
          </div>
          ...
          <div className="row">
              ...
              <div className="row mt-n8 mt-md-n9">
                <div className="col-md-6 col-lg-6">
                  <div className="d-flex mt-8 mt-md-9">
                    ...
                    <div className="ms-5">
                      <p className="fs-lg fw-bold text-white mb-1">Recurrent income</p>

                      <p className="fs-sm text-white-60 mb-0">Benefit from rental income consistently</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6 col-lg-6">
                  <div className="d-flex mt-8 mt-md-9">
                    ...
                    <div className="ms-5">
                      <p className="fs-lg fw-bold text-white mb-1">Value added on property</p>
                ...
                <div className="col-md-6 col-lg-6">
                  <div className="d-flex mt-9">
                    ...
                    <div className="ms-5">
                      <p className="fs-lg fw-bold text-white mb-1">Adjustable investment amount</p>
                      ...
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fillRule="evenodd">
                          ...
                          <path
                            ...
                            fill="#335EEA"
                          />
                          <circle fill="#335EEA" opacity=".3" cx="12" cy="10" r="6" />
                        </g>
                      </svg>
                    </div>

                    <div className="ms-5">
                      <p className="fs-lg fw-bold text-white mb-1">Invest in a portfolio of buildings</p>

                      <p className="fs-sm text-white-60 mb-0">Hassle-free diversification in real estate portfolio.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <img
                src="https://res.cloudinary.com/codack/image/upload/v1651333558/lemox/asset/Bitcoin.svg_owzn8k.png"
                alt="..."
              />
            </div>
          </div>
      ...
      <section className="bg-light">
        <div className="container-lg">
          <div className="row align-items-center justify-content-between">
            <div className="col-md-5 order-md-1 pt-11 pt-md-0 pb-md-12">
              <div className="position-relative">
                <div className="position-absolute bottom-end text-warning mb-n8 me-n8">
                  <svg width="185" height="186" viewBox="0 0 185 186" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="2" cy="2" r="2" fill="currentColor" />
                    <circle cx="22" cy="2" r="2" fill="currentColor" />
                    <circle cx="42" cy="2" r="2" fill="currentColor" />
                ...
                <div className="ratio shadow-lg" style={{ paddingBottom: '120%' }}>
                  <img src="" width="100" alt="..." />
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-5 order-md-0 py-11 py-md-13">
              <h2 className="display-4 mb-4">There has to be a better way to invest in real estate</h2>
              <p className="text-muted">
                Our goal is to make real estate investing as simple as investing in stocks or crypto. Diversification is
                key to any investment strategy, but the barrier to entry for real estate investing has always been so
                high. We don't believe that should be the case.{' '}
              </p>
              <Link className="h6 text-uppercase text-decoration-none" to="/marketplace">
                Marketplace <i className="fe fe-arrow-right ms-2" />
              </Link>
            </div>
          </div>
        </div>
