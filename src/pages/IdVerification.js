      ...
      <Wrapper>
        <Page title="Identity verification">
          ...
          <Stack spacing={1.5} mb={5}>
            ...
            <Typography variant="body1">
              To ensure that your verification goes as smoothly as possible, please access this form from an IP address
              in your country of residence. Accessing this form from countries other than your country of residence, as
              with a VPN (virtual private network), may result in a need for manual review of your application.
            </Typography>
